...
void app_main()
{
	...
	counter++;
	unsigned int *romIDpt, *romIDfirst;
	romIDpt = &ulp_romID;
	romIDfirst = &ulp_romID1;
	...
	printf("---- RomID 1 Byte 1--------- 0x%x\n", *(romIDfirst + 0) & UINT16_MAX);
	printf("---- RomID 1 Byte 2--------- 0x%x\n", *(romIDfirst + 1) & UINT16_MAX);
	printf("---- RomID 1 Byte 3--------- 0x%x\n", *(romIDfirst + 2) & UINT16_MAX);
	printf("---- RomID 1 Byte 4--------- 0x%x\n", *(romIDfirst + 3) & UINT16_MAX);
	printf("---- RomID 1 Byte 5--------- 0x%x\n", *(romIDfirst + 4) & UINT16_MAX);
	printf("---- RomID 1 Byte 6--------- 0x%x\n", *(romIDfirst + 5) & UINT16_MAX);
	printf("---- RomID 1 Byte 7--------- 0x%x\n", *(romIDfirst + 6) & UINT16_MAX);
	printf("---- RomID 1 Byte 8--------- 0x%x\n", *(romIDfirst + 7) & UINT16_MAX);
	printf("\n\n");
	printf("---- RomID 2 Byte 1--------- 0x%x\n", *(romIDpt + 0) & UINT16_MAX);
	printf("---- RomID 2 Byte 2--------- 0x%x\n", *(romIDpt + 1) & UINT16_MAX);
	printf("---- RomID 2 Byte 3--------- 0x%x\n", *(romIDpt + 2) & UINT16_MAX);
	printf("---- RomID 2 Byte 4--------- 0x%x\n", *(romIDpt + 3) & UINT16_MAX);
	printf("---- RomID 2 Byte 5--------- 0x%x\n", *(romIDpt + 4) & UINT16_MAX);
	printf("---- RomID 2 Byte 6--------- 0x%x\n", *(romIDpt + 5) & UINT16_MAX);
	printf("---- RomID 2 Byte 7--------- 0x%x\n", *(romIDpt + 6) & UINT16_MAX);
	printf("---- RomID 2 Byte 8--------- 0x%x\n", *(romIDpt + 7) & UINT16_MAX);
